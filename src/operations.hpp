...
const Operation ADD = {2, [](std::shared_ptr<Generator> t_gen,
                             llvm::Value *t_lhs, llvm::Value *t_rhs) {
                         return t_gen->m_builder.CreateFAdd(t_lhs, t_rhs);
                       }};
const Operation SUB = {2, [](std::shared_ptr<Generator> t_gen,
                             llvm::Value *t_lhs, llvm::Value *t_rhs) {
                         return t_gen->m_builder.CreateFSub(t_lhs, t_rhs);
                       }};
const Operation MULT = {3, [](std::shared_ptr<Generator> t_gen,
                              llvm::Value *t_lhs, llvm::Value *t_rhs) {
                          return t_gen->m_builder.CreateFMul(t_lhs, t_rhs);
                        }};
const Operation DIV = {3, [](std::shared_ptr<Generator> t_gen,
                             llvm::Value *t_lhs, llvm::Value *t_rhs) {
...
const std::map<std::string, Operation> opKeys = {{"+", ADD},    {"-", SUB},
                                                 {"*", MULT},   {"/", DIV},
                                                 {"<", LESSER}, {">", GREATER}};
} // namespace operations
